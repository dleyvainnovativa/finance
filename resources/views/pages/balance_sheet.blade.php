...
@section('content')
<input id="data_url" type="hidden" value='{{route("api.balance-sheet")}}'>
<div class="d-flex justify-content-between align-items-center mb-2">
    <div>
        <h3 id="main_title" class="display">Estado de Posición Financiero</h3>
...
@vite(["resources/js/balance_sheet.js"])
