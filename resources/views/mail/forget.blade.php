                ...
                <tr style="width:100%">
                    <td>
                        ...
                        <h3
                            ...
                            ¿Reiniciarás tu contraseña?
                        </h3>
                        <div
                            style="color:#474849;font-size:14px;font-weight:normal;text-align:left;padding:8px 24px 16px 24px">
                            Si tu no solicitaste cambio de contraseña, no te preocupes.
                            Puedes ignorar este correo.
                        </div>
                        <div style="text-align:left;padding:12px 24px 32px 24px">
                            <a
                                href="{{$resetLink}}"
                                style="color:#FFFFFF;font-size:14px;font-weight:bold;background-color:#31623D;border-radius:4px;display:inline-block;padding:8px 12px;text-decoration:none"
                        ...
                        >&nbsp;</i
                      ><!
                    [endif]--></span><span>Cambiar mi contraseña</span><span><!--[if mso
                      ]><i
